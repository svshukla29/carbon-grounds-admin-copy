...
export function AddTeamMemberDialog({ children }: { children: React.ReactNode }) {
  ...
  const [inviteLink, setInviteLink] = useState("https://carbongrounds.com/invite/team/abc123xyz789")
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          ...
          <DialogDescription>Invite someone to join your Carbon Grounds team</DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="email" className="mt-4">
          ...
          <TabsContent value="link" className="space-y-4 pt-4">
            ...
            <DialogFooter>
              ...
              <Button className="bg-green-600 hover:bg-green-700">Generate New Link</Button>
            </DialogFooter>
          </TabsContent>
        </Tabs>
      </DialogContent>
