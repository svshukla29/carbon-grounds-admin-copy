...
export function FarmersList() {
  ...
  const filteredFarmers = farmers.filter((farmer) => {
    ...
    const matchesLocation =
      locationFilter === "all" || farmer.location.includes(locationFilter);
    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage farmers participating in your sustainability projects
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage all farmers in your projects
          </CardDescription>
        </CardHeader>
        <CardContent>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  router.push(
                                    `/dashboard/farmers/edit/${farmer.id}`,
                                  )
                                }
                              >
