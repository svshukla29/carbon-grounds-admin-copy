        ...
        <TabsContent value="members">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and manage all team members and their assigned roles</CardDescription>
            </CardHeader>
            <CardContent>
              <TeamMembersTable />
            </CardContent>
        ...
        <TabsContent value="roles">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure permissions and access levels for each role</CardDescription>
            </CardHeader>
            <CardContent>
              <RoleManagement />
            </CardContent>
        ...
        <TabsContent value="invites">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track and manage invitations sent to new team members</CardDescription>
            </CardHeader>
